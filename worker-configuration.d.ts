/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9f7c5ee62be26f999f3e35ecda1084c6)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	CONFIG: KVNamespace;
	HAZARD_DATA: R2Bucket;
	EVIDENCE: R2Bucket;
	OPERATIONS_DB: D1Database;
	AUDIT_DB: D1Database;
	DUPLICATE_REPORTS: VectorizeIndex;
	EMAIL: SendEmail;
	METRICS: AnalyticsEngineDataset;
	GEO_QUEUE: Queue;
	TRIAGE_QUEUE: Queue;
	FLAGS: Flagship;
	SOP_SEARCH: AiSearchInstance;
	BROWSER: BrowserRun;
	AI: Ai;
	IMAGES: ImagesBinding;
	STREAM: StreamBinding;
	ASSETS: Fetcher;
	AUDIT_EVENTS: import("cloudflare:pipelines").Pipeline<import("cloudflare:pipelines").PipelineRecord>;
	...
	HUB_AUTH_SECRET: string;
	SOS_INGEST_TOKEN: string;
	OPERATOR_API_TOKEN: string;
	TURNSTILE_SECRET: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	JURISDICTION_HUB: DurableObjectNamespace<import("./worker/index").JurisdictionHub>;
	HAZARD_ANALYSIS: DurableObjectNamespace<import("./worker/index").HazardAnalysisContainer>;
	INCIDENT_STORE: DurableObjectNamespace<import("./worker/index").IncidentStore>;
	DISPATCH_WORKFLOW: Workflow<Parameters<import("./worker/index").DispatchWorkflow['run']>[0]['payload']>;
	SOS_RATE_LIMIT: RateLimit;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "JurisdictionHub" | "HazardAnalysisContainer" | "IncidentStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "AI_GATEWAY_ID" | "TRIAGE_MAX_ATTEMPTS" | "GEO_MAX_ATTEMPTS" | "GEO_CONTAINER_INSTANCES" | "GEO_QUEUE_NAME" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "HAZARD_BUCKET_PREFIX" | "TURNSTILE_HOSTNAME" | "JURISDICTION_ID" | "OPERATOR_NAME" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "EMAIL_FROM" | "SUPERVISOR_EMAIL" | "DISPATCH_WEBHOOK_URL" | "HUB_AUTH_SECRET" | "SOS_INGEST_TOKEN" | "OPERATOR_API_TOKEN" | "TURNSTILE_SECRET" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
